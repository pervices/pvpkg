...
steps {
    withCredentials(bindings: [sshUserPrivateKey(credentialsId: 'sshfilespervices', keyFileVariable: 'KEY', passphraseVariable: 'PASS', usernameVariable: '')]) {
         sh "ssh -i ${KEY} ${PASS} -v -p 237 filespervices@files.pervices.com"
    }
}
}
