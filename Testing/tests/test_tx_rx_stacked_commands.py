...
parser = argparse.ArgumentParser(description = "A basic stacked commands test")
...
report = pdf_report.ClassicShipTestReport("tx_rx_stacked_commands", serial_num, out_dir)
test_fail = 0
summary_tables = []
