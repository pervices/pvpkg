...
def main(iterations, title="TX RX Long-term Loopback Test") -> int:
    ...
    command = "/usr/lib/uhd/examples/rx_to_tx_loopback --rate={} --tx_channels={} --rx_channels={} --tx_freq={} --rx_freq={} --tx_gain={} --rx_gain={} --nsamps={}".format(
    ...
    try: 
        ...
        report.insert_title_page("Tx Rx Long-term Loopback Test")
...
for it in generator.tx_rx_loopback():
    main(it)
