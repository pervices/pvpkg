...
report = pdf_report.ClassicShipTestReport("rx_rate", targs.serial, targs.report_dir, targs.docker_sha, targs.addr)
test_fail = 0
...
if(targs.product == "Vaunt"):
    main(gen.crimson.lo_band.rx_rate(4))
elif(targs.product == "Avery"):
    main(gen.calamine.lo_band.rx_rate(4))
