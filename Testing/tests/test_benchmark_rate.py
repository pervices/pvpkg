...
rx_benchmark(header='Rx, multi-streamer, fc32, 5s delay', rx_rate=20e6, rx_cpu='fc32', rx_delay=5)
rx_benchmark(header='Rx, single, fc32, 0s delay', rx_rate=20e6, rx_cpu='fc32', multi_streamer=False)
