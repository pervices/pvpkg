...
def test(it, data):
    ...
    try:
        ...
        if attempt_num < max_attempts:
            ...
            log.pvpkg_log_error("TX_RX_FUNDAMENTAL_FREQUENCY", "Reached max number of retries without getting any data. This iteration will be marked as DNF and the test will continue.")
            test_dnf = True
