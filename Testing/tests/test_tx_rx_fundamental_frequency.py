...
parser = argparse.ArgumentParser(description = "A basic loopback test verifying frequency tuning works")
...
report = pdf_report.ClassicShipTestReport("tx_rx_fundamental_frequency", serial_num, out_dir)
test_fail = 0
summary_tables = []
