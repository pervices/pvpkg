...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description = "TX RX Gain test for verifying gain settings work and have effect on signal area")
    ...
    report = pdf_report.ClassicShipTestReport("tx_rx_gain", serial_num, out_dir)
