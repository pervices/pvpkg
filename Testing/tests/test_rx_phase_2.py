...
def main():
    ...
    global report
    report = pdf_report.ClassicShipTestReport("rx_phase_2", targs.serial, targs.report_dir, targs.docker_sha, targs.addr)
    ...
    for it in iterations:
        ...
        log.pvpkg_log_info("RX_PHASE_2", "Phase Results:", before="\n")
