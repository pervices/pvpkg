...
def calibrate1(end, channels, sample_rate, center_freq, gain):
...
def calibrate2(end, channels, sample_rate, center_freq, gain):
...
def get_snk_s(channels, sample_rate, center_freq, gain):
    ...
    calibrate1(snk, channels, sample_rate, center_freq, gain)
    return snk
...
def get_src_c(channels, sample_rate, center_freq, gain):
    ...
    calibrate2(src, channels, sample_rate, center_freq, gain)
    return src
