...
def calibrate_tx(end, channels, sample_rate, center_freq, gain):
...
def calibrate_rx(end, channels, sample_rate, center_freq, gain):
...
def get_snk_s(channels, sample_rate, center_freq, gain):
    ...
    calibrate_tx(snk, channels, sample_rate, center_freq, gain)
    return snk
...
def get_src_c(channels, sample_rate, center_freq, gain):
    ...
    calibrate_rx(src, channels, sample_rate, center_freq, gain)
    return src
