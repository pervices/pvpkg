...
class TestArgs:
    ...
    def __init__(self, parser=None, testDesc=""):
        ...
        parser.add_argument('-c', '--channels', required=False, type=int, nargs='+', default=[0,1,2,3], metavar="CHANNEL", help="Channel list to use for testing. Example usage: --channels 0 1 2 3")
