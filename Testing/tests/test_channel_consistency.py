...
test_plots = dump_dir + iso_time + "-channel_consistency"
...
def main():
    ...
    # PDF Report
    global report
    report = pdf_report.ClassicShipTestReport("channel_consistency", targs.serial, targs.report_dir, targs.docker_sha)
    report.insert_title_page("Low Band TX RX Channel Consistency Test")
