...
NUM_TESTS=10
TEST_NAMES=("TX/RX Fundamental Frequency" "TX Trigger" "TX/RX Gain" "TX/RX Phase Short" "GPIO Stack Test" "RX Stack Test 1"  "RX Stack Test 2" "Benchmark Rate Test" "TX Stack Test" "TX/RX Stacked Commands" "Tx/Rx Long Phase Coherency Test")
TEST_FILES=(test_tx_rx_fundamental_frequency test_tx_trigger test_tx_rx_gain test_tx_rx_phase test_gpio_stack test_rx_stack test_rx_stack_2 test_benchmark_rate test_tx_stack test_tx_rx_stacked_commands test_tx_rx_phase_2 )
TEST_EXCEPTIONS=(false false false false false false false true false true true)
