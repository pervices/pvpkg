...
NUM_TESTS=10
TEST_NAMES=("TX/RX Fundamental Frequency" "TX Trigger" "TX/RX Gain" "TX/RX Phasei Short (2 cycles)" "GPIO Stack Test" "RX Stack Test 1" "RX Stack Test 2" "TX Stack Test" "TX/RX Stacked Commands" "Tx/Rx Long Phase Coherency Test" )
