...
TEST_FILES=(test_tx_rx_channels_in_phase test_tx_trigger test_tx_rx_gain test_tx_rx_fundamental_frequency test_tx_rx_phase test_gpio_stack test_rx_stack test_rx_stack_2 test_tx_stack test_tx_rx_stacked_commands )
TEST_EXCEPTIONS=(false false false false false false false false false true)
